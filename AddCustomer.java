...
public class AddCustomer extends JFrame implements ActionListener {
    ...
    JLabel heading, lblname, lblnationality, lblaadhar, lbladdress, lblgender, lblphone;
   ...
   public AddCustomer()
   {
       ...
       // ButtonGroup only one button work at a time
       
       ButtonGroup gendergroup = new ButtonGroup();
       
       // radion Button for male

       rbmale = new JRadioButton("Male");
       rbmale.setBounds(300, 280, 70, 25);
       rbmale.setBackground(Color.WHITE);
       add(rbmale);
       
       
       // radion Button for Female

       rbfemale = new JRadioButton("Female");
       rbfemale.setBounds(220, 280, 70, 25);
